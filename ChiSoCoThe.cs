...
namespace HealthyApp
{
	public partial class ChiSoCoThe : Form
	{
		...
		private void btTinhtoan_Click(object sender, EventArgs e)
		{
			...
			string truyvan = string.Format("use HealthyApp insert into Lichsuxemchisocothe values (GETDATE(),{0},{1},{2},N'{3}')", txtChieucao.Text, txtCannang.Text, txtChisoBMI.Text, lbDanhgia.Text);
